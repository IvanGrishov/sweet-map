...
function mlm_render_docs() {
  ...
  <div class="wrap mlm-guide">
    <h1 class="mlm-guide__title"><?php esc_html_e('Guide', 'sweet-map'); ?></h1>

    <div class="mlm-guide__body">

      <h2 class="mlm-guide__section-title">🚀 <?php esc_html_e('Getting started', 'sweet-map'); ?></h2>
      <p class="mlm-guide__text"><?php esc_html_e('Insert the shortcode on any page, post or widget:', 'sweet-map'); ?></p>
      <pre class="mlm-guide__pre">[sweet_map]</pre>

      <h2 class="mlm-guide__section-title">🧩 <?php esc_html_e('Gutenberg block', 'sweet-map'); ?></h2>
      <p class="mlm-guide__text"><?php echo wp_kses(__('In the block editor, click <strong>+</strong>, search "Sweet Map" and add the block. Select a map from the sidebar panel on the right — the full interactive map will appear on your page.', 'sweet-map'), $kses_strong); ?></p>

      <h2 class="mlm-guide__section-title">🗺️ <?php esc_html_e('Multiple maps', 'sweet-map'); ?></h2>
      <p class="mlm-guide__text"><?php esc_html_e('Each map has its own markers and settings. Create maps in the Maps section and use unique IDs in shortcodes:', 'sweet-map'); ?></p>
      <pre class="mlm-guide__pre">[sweet_map id="offices"]
[sweet_map id="stores"]</pre>

      <h2 class="mlm-guide__section-title mlm-guide__section-title--spaced">📍 <?php esc_html_e('Marker features', 'sweet-map'); ?></h2>
      ...
      <h2 class="mlm-guide__section-title mlm-guide__section-title--spaced">⚙️ <?php esc_html_e('Map settings', 'sweet-map'); ?></h2>
      <ul class="mlm-guide__list">
      ...
      <h2 class="mlm-guide__section-title mlm-guide__section-title--spaced">✏️ <?php esc_html_e('How to add a marker', 'sweet-map'); ?></h2>
      ...
      <h2 class="mlm-guide__section-title mlm-guide__section-title--spaced">⌨️ <?php esc_html_e('Keyboard shortcut', 'sweet-map'); ?></h2>
      <p class="mlm-guide__text--last"><?php
        ...
        printf(wp_kses($fmt, $kses_kbd), '<kbd class="mlm-guide__kbd">Enter</kbd>');
      ?></p>
